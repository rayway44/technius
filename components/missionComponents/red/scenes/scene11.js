...
export default function Scene11({setCurrentScene, answers, setAnswers, setOpenStartOverDialog}) {
    ...
    useEffect(() => {
        if (answers.scene10 === 'A') {
            setVideo("https://technius2022.s3.amazonaws.com/missionAssets/scene11/redScene11A.mp4")
            setWebVideo("https://technius-sydney.s3.ap-southeast-2.amazonaws.com/missionAssets/scene11/redScene11A.webm")
            setPopupTime(23)
        } else if(answers.scene10 === 'B') {
            setVideo("https://technius2022.s3.amazonaws.com/missionAssets/scene11/redScene11B&C.mp4")
            setWebVideo("https://technius-sydney.s3.ap-southeast-2.amazonaws.com/missionAssets/scene11/redScene11B%26C.webm")
            setPopupTime(23)
