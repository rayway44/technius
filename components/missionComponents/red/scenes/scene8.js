    ...
    return (
        <>
            <video poster="/loading_screen.gif" playsInline ref={scene8} onTimeUpdate={handleTimeChange} className={styles.backgroundVideo} autoPlay muted>
                {/* <source src={"https://technius2022.s3.amazonaws.com/missionAssets/scene8/redScene8.mp4"} type="video/mp4" /> */}
                <source src={"https://technius-sydney.s3.ap-southeast-2.amazonaws.com/missionAssets/scene8/redScene8.webm"} type="video/webm" />
