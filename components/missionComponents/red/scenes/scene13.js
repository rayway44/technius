...
export default function Scene13({setCurrentScene, answers, setAnswers, setOpenStartOverDialog}) {
    ...
    useEffect(() => {
        setVideo("https://technius2022.s3.amazonaws.com/missionAssets/scene13/redScene13.mp4")
        setWebVideo("https://technius-sydney.s3.ap-southeast-2.amazonaws.com/missionAssets/scene13/redScene13.webm")
        setPopupTime(24)
