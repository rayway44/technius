...
export default function Scene15({setCurrentScene, answers, setAnswers, setOpenStartOverDialog}) {
    ...
    const [videoWeb, setWwebVideo] = useState('')
    ...
    useEffect(() => {
        setVideo("https://technius2022.s3.amazonaws.com/missionAssets/scene15/redScene15.mp4")
        setWwebVideo("https://technius-sydney.s3.ap-southeast-2.amazonaws.com/missionAssets/scene15/redScene15.webm")
        setPopupTime(20)
