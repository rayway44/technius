...
export default function Scene14({setCurrentScene, answers, setAnswers, setOpenStartOverDialog}) {
    ...
    useEffect(() => {
        if (answers.scene13 === 'A') {
            setVideo("https://technius2022.s3.amazonaws.com/missionAssets/scene14/redScene14A.mp4")
            setWebVideo("https://technius-sydney.s3.ap-southeast-2.amazonaws.com/missionAssets/scene14/redScene14A.webm")
            setPopupTime(38)
        } else if(answers.scene13 === 'B') {
            setVideo("https://technius2022.s3.amazonaws.com/missionAssets/scene14/redScene14B.mp4")
            setWebVideo("https://technius-sydney.s3.ap-southeast-2.amazonaws.com/missionAssets/scene14/redScene14B.webm")
            setPopupTime(38)
        } else if(answers.scene13 === 'C') {
            setVideo("https://technius2022.s3.amazonaws.com/missionAssets/scene14/redScene14C.mp4")
            setWebVideo("https://technius-sydney.s3.ap-southeast-2.amazonaws.com/missionAssets/scene14/redScene14C.webm")  
            setPopupTime(38)
        }
    }, [])
