    ...
    return (
        <>
            <video poster="/loading_screen.gif" playsInline ref={vid} onTimeUpdate={handleTimeChange} className={styles.backgroundVideo} autoPlay muted>
                <source src={"https://technius-nine.vercel.app/missionAssets/scene5/greenScene5.mp4"} type="video/mp4" />
                video not supported in this browser
            </video>
            { videoTime > 5 &&
                <>
                    <Grid style={{position: "absolute", width: (matches ? "31%" : "30%"), right: (matches ? "6.5%" : "9%"), top: (matches ? "38.8%" : "38.6%"), zIndex: '10'}} container spacing={0}>
                        <Grid item xs={4}>
