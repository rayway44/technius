...
export default function Scene12({setCurrentScene, answers, setAnswers, setOpenStartOverDialog}) {
    ...
    useEffect(() => {
        setVideo("https://technius2022.s3.amazonaws.com/missionAssets/scene12/greenScene12.mp4")
        setWebVideo("https://technius-sydney.s3.ap-southeast-2.amazonaws.com/missionAssets/scene12/greenScene12.webm")
        setPopupTime(15)
