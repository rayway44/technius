...
export default function Scene10({setCurrentScene, answers, setAnswers, setOpenStartOverDialog}) {
    ...
    useEffect(() => {
        if (answers.scene9 === 'A') {
            setVideo("https://technius2022.s3.amazonaws.com/missionAssets/scene10/greenScene10A.mp4")
            setWebVideo("https://technius-sydney.s3.ap-southeast-2.amazonaws.com/missionAssets/scene10/greenScene10A.webm")
            setPopupTime(35)
        } else if(answers.scene9 === 'B') {
            setVideo("https://technius2022.s3.amazonaws.com/missionAssets/scene10/greenScene10B.mp4")
            setWebVideo("https://technius-sydney.s3.ap-southeast-2.amazonaws.com/missionAssets/scene10/greenScene10B.webm")
            setPopupTime(35)
        } else if(answers.scene9 === 'C') {
            setVideo("https://technius2022.s3.amazonaws.com/missionAssets/scene10/greenScene10C.mp4")
            setWebVideo("https://technius-sydney.s3.ap-southeast-2.amazonaws.com/missionAssets/scene10/greenScene10C.webm")
            setPopupTime(35)
        }
    })
