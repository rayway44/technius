...
export default function Scene11({setCurrentScene, answers, setAnswers, setOpenStartOverDialog}) {
    ...
    useEffect(() => {
        if (answers.scene10 === 'A') {
            setVideo("https://technius2022.s3.amazonaws.com/missionAssets/scene11/yellowScene11A.mp4")
            setWebVideo("https://technius-sydney.s3.ap-southeast-2.amazonaws.com/missionAssets/scene11/yellowScene11A.webm")
            setPopupTime(23)
