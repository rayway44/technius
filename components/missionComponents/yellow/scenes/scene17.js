...
export default function Scene17({setCurrentScene, answers, setAnswers, setOpenStartOverDialog}) {
    const scene17 = useRef()
    ...
    useEffect(() => {
        setVideo("https://technius2022.s3.amazonaws.com/missionAssets/scene17/yellowScene17.mp4")
        setWebVideo("https://technius-sydney.s3.ap-southeast-2.amazonaws.com/missionAssets/scene15/yellowScene17.webm")
        setPopupTime(45)
    ...
    return (
        <>
            <video poster="/loading_screen.gif" playsInline ref={scene17} onTimeUpdate={handleTimeChange} className={styles.backgroundVideo} autoPlay muted>
