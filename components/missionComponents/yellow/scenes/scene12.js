...
export default function Scene12({setCurrentScene, answers, setAnswers, setOpenStartOverDialog}) {
    const scene12 = useRef()
    ...
    useEffect(() => {
        setVideo("https://technius2022.s3.amazonaws.com/missionAssets/scene12/yellowScene12.mp4")
        setWebVideo("https://technius-sydney.s3.ap-southeast-2.amazonaws.com/missionAssets/scene12/yellowScene12.webm")
        setPopupTime(15)
    ...
    return (
        <>
            <video poster="/loading_screen.gif" playsInline ref={scene12} onTimeUpdate={handleTimeChange} className={styles.backgroundVideo} autoPlay muted>
