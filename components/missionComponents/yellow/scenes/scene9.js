...
export default function Scene9({setCurrentScene, answers, setAnswers, setOpenStartOverDialog}) {
    const scene9 = useRef()
    ...
    useEffect(() => {
        if (answers.scene8 === 'A') {
            ...
            setWebVideo("https://technius-sydney.s3.ap-southeast-2.amazonaws.com/missionAssets/scene9/scene9A.webm")
            setPopupTime(27)
        } else if(answers.scene8 === 'B') {
            setVideo("https://technius2022.s3.amazonaws.com/missionAssets/scene9/yellowScene9B.mp4")
            setWebVideo("https://technius-sydney.s3.ap-southeast-2.amazonaws.com/missionAssets/scene9/yellowScene9B.webm")
            setPopupTime(25)
        } else if(answers.scene8 === 'C') {
            setVideo("https://technius2022.s3.amazonaws.com/missionAssets/scene9/yellowScene9C.mp4")
            setWebVideo("https://technius-sydney.s3.ap-southeast-2.amazonaws.com/missionAssets/scene9/yellowScene9C.webm")
            setPopupTime(32)
        }
    })
