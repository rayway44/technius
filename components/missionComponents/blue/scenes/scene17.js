...
export default function Scene17({setCurrentScene, answers, setAnswers, setOpenStartOverDialog}) {
    ...
    useEffect(() => {
        setVideo("https://technius2022.s3.amazonaws.com/missionAssets/scene17/blueScene17.mp4")
        setWebVideo("https://technius-sydney.s3.ap-southeast-2.amazonaws.com/missionAssets/scene17/blueScene17.webm")
        setPopupTime(45)
    ...
    return (
        <>
            <video poster="/loading_screen.gif" playsInline ref={scene17} onTimeUpdate={handleTimeChange} className={styles.backgroundVideo} autoPlay muted>
                ...
                <source src={vivideoWebdeo} type="video/mp4" />
