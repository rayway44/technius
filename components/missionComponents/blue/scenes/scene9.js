...
export default function Scene9({setCurrentScene, answers, setAnswers, setOpenStartOverDialog}) {
    ...
    useEffect(() => {
        if (answers.scene8 === 'A') {
            ...
            setVideo("https://technius2022.s3.amazonaws.com/missionAssets/scene9/blueScene9B.mp4")
            setWebVideo("https://technius-sydney.s3.ap-southeast-2.amazonaws.com/missionAssets/scene9/blueScene9B.webm")
            setPopupTime(25)
        } else if(answers.scene8 === 'C') {
            setVideo("https://technius2022.s3.amazonaws.com/missionAssets/scene9/blueScene9C.mp4")
            setWebVideo("https://technius-sydney.s3.ap-southeast-2.amazonaws.com/missionAssets/scene9/blueScene9C.webm")
            setPopupTime(32)
        }
    })
