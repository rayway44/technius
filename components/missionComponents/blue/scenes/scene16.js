...
export default function Scene16({setCurrentScene, answers, setAnswers, setOpenStartOverDialog}) {
    const scene16 = useRef()
    ...
    useEffect(() => {
        setVideo("https://technius2022.s3.amazonaws.com/missionAssets/scene16/scene16.mp4")
