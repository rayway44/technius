    ...
    return (
        <>
            <video poster="/loading_screen.gif" playsInline ref={vid} onTimeUpdate={handleTimeChange} className={styles.backgroundVideo} autoPlay muted>
                <source src={"https://technius-sydney.s3.ap-southeast-2.amazonaws.com/missionAssets/scene5/blueScene5.webm"} type="video/webm" />
            ...
            { videoTime > 5 &&
                <>
                    <Grid style={{position: "absolute", width: (matches ? "31%" : "30%"), right: (matches ? "6%" : "8%"), top: (matches ? "39.5%" : "39%"), zIndex: '10'}} container spacing={0}>
                        <Grid item xs={4}>
