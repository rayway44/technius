...
export default function ReportPageTop({ attr1, attr2 }) {
    let skill1 = '';
    let skill2 = '';
    ...
    return (
        <div className={styles.reportPageTopRoot}>
            <div className={styles.header}>
                <div className={styles.headerText}>YOU MADE IT!</div>
            ...
            <div className={styles.mySuperpowers}>
                ...
                <p>
                    ...
                    journey tell us that you have very well developed <b>{skill1} skills</b> and <b>{skill2} skills</b>. Because of this, you’ve been able to bring some very valuable 
            ...
            <div className={styles.myFutureInTech}>
                ...
                <p>
                    ...
                    process, what you are good at doing, and what you might be able to do with those 
